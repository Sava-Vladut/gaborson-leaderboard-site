...
interface Props {
  ...
  /** Render only the input, without the outer page padding wrapper. */
  bare?: boolean;
}

export default function SearchBar({ query, onChange, bare = false }: Props) {
  const field = (
  ...
  return (
    <div className="px-6 py-3">
      <div className="max-w-7xl mx-auto">{field}</div>
    </div>
  );
}
